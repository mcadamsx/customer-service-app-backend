...
from ..models import AdminUser  # or wherever your models are
from AdminAccounts.models import Customer, Ticket  # adjust to your app names
from AdminAccounts.models import Service  # adjust to your app names
